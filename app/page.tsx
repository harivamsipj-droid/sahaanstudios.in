...
export default function HomePage() {
  ...
  return <main>
    ...
    <section className="partner-cta"><div><p className="eyebrow">For beauty professionals</p><h2>Your talent deserves<br /><em>the right clients.</em></h2><p>Build a trusted Sahaan profile, choose when and where you work, and receive quality home-service booking requests.</p><Button render={<a href="/partners" />}>Apply as a founding professional <ArrowRight /></Button></div><div className="partner-cta-stats"><span><strong>0%</strong><small>commission on your first 10 bookings</small></span><span><strong>18%</strong><small>standard commission after launch offer</small></span><span><strong>Weekly</strong><small>transparent payout statements</small></span></div></section>
    <footer className="market-footer"><a className="market-brand" href="/"><span className="market-monogram">S</span><span><strong>SAHAAN</strong><small>BEAUTY AT HOME</small></span></a><div><strong>Customers</strong><a href="/professionals">Search Hyderabad</a><a href="#services">Services & pricing</a><a href="#how">How Sahaan works</a></div><div><strong>Professionals</strong><a href="/partners">Apply to join</a><a href="/partners#earnings">Earnings calculator</a><a href="/partners#application">Application form</a></div><div><strong>Trust & legal</strong><a href="#trust">Verification standards</a><a href="/privacy">Privacy policy</a><a href="/terms">Terms of use</a></div><small>© 2026 Sahaan · Hyderabad launch marketplace for independent beauty professionals. Google-listed businesses are not automatically Sahaan-verified.</small></footer>
