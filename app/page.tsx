...
export default function HomePage() {
  ...
  return <main>
    ...
    <footer className="market-footer"><a className="market-footer-logo" href="/" aria-label="Sahaan Studios home"><img src="/brand/sahaan-horizontal-cherry-v1.png" alt="Sahaan Studios" loading="lazy" /></a><div><strong>Customers</strong><a href="/professionals">Search Hyderabad</a><a href="#services">Services & pricing</a><a href="#how">How Sahaan works</a></div><div><strong>Professionals</strong><a href="/partners">Apply to join</a><a href="/partners#earnings">Earnings calculator</a><a href="/partners#application">Application form</a></div><div><strong>Trust & legal</strong><a href="#trust">Verification standards</a><a href="/privacy">Privacy policy</a><a href="/terms">Terms of use</a></div><p className="market-footer-tagline">Your expression. Our essence.</p><small>© 2026 Sahaan · Hyderabad launch marketplace for independent beauty professionals. Google-listed businesses are not automatically Sahaan-verified.</small></footer>
